...
cekMrd.onreadystatechange = function() {
  ...
  cekMrd.open("GET", url+"?action=read&kelas="+kelas+"&ta="+thnAjar+"&semester="+semester+"&sheet=Data Murid", true);
  cekMrd.send();
...
tmbhMrd.onreadystatechange = function() {
  ...
  function tambahMurid(){
    ...
    if (nam =="") {
      ...
      tmbhMrd.open("GET", url+"?action=insert&kelas="+kelas+"&ta="+thnAjar+"&semester="+semester+"&sheet=Data Murid&nomor="+nom+"&isi="+nam, true);
      tmbhMrd.send();
      $('#lagi_nambah').show();
      $('#oto_nom').hide();
    }
  ...
  function updateMurid(){
    ...
    if (namUpdt == "") {
      ...
      updtMrd.open("GET", url+"?action=update&kelas="+kelas+"&ta="+thnAjar+"&semester="+semester+"&sheet=Data Murid&nomor="+noUpdt+"&nama="+namUpdt, true);
      updtMrd.send();
      $('#lagi_edit').show();
    }
  }
  ...
  function hapusMurid(){
      ...
      if (has.length == 1) {
      tmbhMrd.open("GET", url+"?action=insert&kelas="+kelas+"&ta="+thnAjar+"&semester="+semester+"&sheet=Data Murid&nomor="+noHps+"&isi=None", true);
      tmbhMrd.send();
      }
      hpsMrd.open("GET", url+"?action=delete&kelas="+kelas+"&ta="+thnAjar+"&semester="+semester+"&sheet=Data Murid&nama="+namHps, true);
      hpsMrd.send();
      $('#lagi_edit').show();
