...
function onDeviceReady() {
    ...
    window.plugins.OneSignal.sendTags({akses: "guru", wali_kelas: usr_g['KELAS'], username: usr_g['USERNAME']})
...
function logOut(){
  function onDeviceReady() {
    ...
    window.plugins.OneSignal
        ...
        .inFocusDisplaying(window.plugins.OneSignal.OSInFocusDisplayOption.Notification)
        .endInit();
        window.plugins.OneSignal.deleteTags(["akses", "wali_kelas", "username" ]);
