    ...
    $('#errAbsen').modal('show');
      ...
      const mod2 = document.getElementById('modalK2');
          ...
          mod2.innerHTML = 'tanggal ' +tanggal+' Terkirim'; 
            ...
            $.post("https://api.telegram.org/bot1175506101:AAEEzBNKKc_KCAw8FVNhABJKU-LZGvEVsc8/sendMessage?chat_id=1206954683&text="+tanggal+'✅ *'+nama+'* : '+hasil+"&parse_mode=Markdown");
